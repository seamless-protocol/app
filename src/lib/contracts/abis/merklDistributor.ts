/**
 * Merkl Distributor Contract ABI
 *
 * This is the ABI for the Merkl distributor contract used for claiming rewards.
 * The contract handles merkle tree-based reward distribution with dispute mechanisms.
 */
...
// Export the ABI as a type for better TypeScript support
export type MerklDistributorAbi = typeof merklDistributorAbi
