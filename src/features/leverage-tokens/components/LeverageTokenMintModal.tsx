      ...
      case 'confirm':
        return (
          <div className="space-y-6">
            ...
            <Button onClick={handleConfirm} variant="gradient" className="w-full h-12 font-medium">
      ...
      case 'success':
        return (
          <div className="space-y-6 text-center">
            ...
            <Button onClick={handleClose} variant="gradient" className="w-full h-12 font-medium">
              Done
            </Button>
          </div>
        )
        ...
        return (
          <div className="space-y-6 text-center">
            ...
            <div className="flex space-x-3">
              ...
              <Button onClick={handleClose} variant="gradient" className="flex-1">
                Close
              </Button>
            </div>
          </div>
