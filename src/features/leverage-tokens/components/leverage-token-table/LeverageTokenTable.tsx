          ...
          <div className="flex items-center space-x-3 lg:ml-auto">
            <div className="relative w-full lg:w-auto">
              ...
              <input
                ...
                className="file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground flex min-w-0 rounded-md border px-3 py-1 text-base outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm focus-visible:ring-[var(--brand-secondary)] focus-visible:ring-opacity-50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive pl-10 w-full lg:w-64 h-8 transition-all duration-200 lg:focus:w-80 bg-input border-[var(--divider-line)] text-[var(--text-primary)]"
              />
            </div>
          </div>
        </div>
