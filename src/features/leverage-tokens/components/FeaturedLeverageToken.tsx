...
export function FeaturedLeverageToken({
  ...
  return (
    ...
    >
      <Card
        className="w-full min-w-0 cursor-pointer transform transition-all duration-300 border border-[var(--divider-line)] bg-[color-mix(in_srgb,var(--surface-card)_92%,transparent)] hover:border-[var(--nav-border-active)] hover:bg-[color-mix(in_srgb,var(--surface-elevated)_45%,transparent)] hover:scale-[1.01] hover:shadow-[0_16px_40px_-18px_var(--nav-border-active)]"
        onClick={handleClick}
      >
