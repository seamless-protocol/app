    ...
    },
    {
      ...
      answer: (
        <p>
          ...
          utilize the <strong>Swap/Bridge widget</strong> in the app to swap directly into{' '}
    ...
    },
    {
      ...
      answer: (
        <p>
          ...
          to a <strong>yield farming</strong> or <strong>carry trade</strong>
          strategy rather than a directional <strong>{debtAsset.symbol}</strong> bet.
        </p>
      ),
    },
    {
      ...
      answer: (
        <div>
          <p>
            ...
            Everything happens automatically - no manual steps are needed by the user.
          </p>
          <p className="mt-3">
    ...
    },
    {
      ...
      answer: (
        <div>
          ...
          <p className="mt-3">Here are some key risks to be aware of/consider:</p>
          <ul className="mt-2 list-disc list-inside space-y-1">
            <li>
