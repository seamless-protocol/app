...
export function MorphoVaultsInfoCard({ className }: MorphoVaultsInfoCardProps) {
  return (
    <Card
      className={`text-card-foreground flex flex-col gap-6 rounded-xl border bg-card border-border hover:bg-accent transition-all duration-300 ${className ?? ''}`}
    >
      <CardContent className="p-6">
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 rounded-xl bg-[color-mix(in_srgb,var(--brand-primary)_18%,transparent)] flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button asChild variant="gradient" className="flex items-center gap-2">
