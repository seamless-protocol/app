// E2E env source
// - Uses TEST_RPC_URL/TEST_RPC_KIND environment variables directly from Tenderly script
// - Falls back to tests/shared/env if no TEST_RPC_* variables are set
// - This ensures E2E and integration can share the exact same RPC in CI or locally
import { defineConfig, devices } from '@playwright/test'
import { ENV } from './tests/shared/env'

// Use TEST_RPC_URL directly if provided (from Tenderly script), otherwise fall back to shared env
const TEST_RPC_URL = process.env['TEST_RPC_URL'] ?? ENV.RPC_URL
