...
- Goals: Validate mint planning (V2), execution (V2), allowances, preview UX, and full user journeys.
...
- orchestrateMint
  - Requires `quoteDebtToCollateral` or throws.
  - Returns result `{ hash, plan }`.
