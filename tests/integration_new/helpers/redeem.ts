...
import { getContractAddresses, leverageManagerV2Abi } from '@/lib/contracts'
    ...
    try {
      ...
      const isRetryableError =
        ...
        (error instanceof Error &&
          error.message.toLowerCase().includes('try increasing your collateral slippage tolerance'))
